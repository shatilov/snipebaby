...
?>
<div id="<?php echo $maps_id; ?>" class="ymaps<?php echo $moduleclass_sfx ?>"style="width:<?php echo $width ?>;height:<?php echo $height ?>;"><? if ($ymap = '') echo "Неверно указаны или отсутствуют координаты метки"; ?></div>
