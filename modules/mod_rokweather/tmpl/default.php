		...
		<div class="rokweather-wrapper">
			...
			?>
				...
				<?php
					...
					$the_icon = $day['icon'];
					if (stripos($the_icon, 'www.google.com') <= 0) $the_icon = $icon_url."/grey/images/weather/".$day['icon'];
				
				?>
	            <div class="day">
	                <span><?php echo $day['day_of_week']; ?></span><br />
	                   <img src="<?php echo $the_icon; ?>" alt="<?php echo $day['condition']; ?>" title="<?php echo $day['condition']; ?>" /><br />
