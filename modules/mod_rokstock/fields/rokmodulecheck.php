...
class JFormFieldRokmodulecheck extends JFormField
{
    ...
    public function getInput()
    {
        ...
        if (file_exists($rokmodule)) return "<span $success_style>You successfully passed the RokModule check.</span>"; else return "<span $warning_style>You failed the RokModule check. In order to properly use this module, it is necessary that you install the latest RokModule version. Please <a target='_blank' href='http://www.rockettheme.com/extensions-downloads/free/1012-rokmodule'>click here</a> to download it.</span>";
    }
