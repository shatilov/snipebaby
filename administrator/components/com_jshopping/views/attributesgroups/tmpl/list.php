...
<?php foreach ($rows as $row){?>
  <tr class="row<?php echo $i % 2;?>">
   ...
   <td align="right" width="20">
    <?php
        if ($i!=0) echo '<a href="index.php?option=com_jshopping&controller=attributesgroups&task=order&id='.$row->id.'&move=-1"><img alt="'._JSHOP_UP.'" src="components/com_jshopping/images/uparrow.png"/></a>';
    ?>
   </td>
   <td align="left" width="20">
    <?php
        if ($i!=$count-1) echo '<a href="index.php?option=com_jshopping&controller=attributesgroups&task=order&id='.$row->id.'&move=1"><img alt="'._JSHOP_DOWN.'" src="components/com_jshopping/images/downarrow.png"/></a>';
    ?>
   </td>
   ...
   <td align="center">
        <a href='index.php?option=com_jshopping&controller=attributesgroups&task=edit&id=<?php print $row->id;?>'><img src='components/com_jshopping/images/icon-16-edit.png'></a>
   </td>
   <td align="center">
    <?php print $row->id;?>
   </td>
