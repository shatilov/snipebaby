...
require_once( JPATH_COMPONENT.DS.'helpers'.DS.'phocadownloadlayout.php' );
...
require_once( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_phocadownload'.DS.'helpers'.DS.'fileupload.php' );
require_once( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_phocadownload'.DS.'helpers'.DS.'phocadownloadrate.php' );
