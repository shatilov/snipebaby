...
<body id="bd" class="fs<?php echo $tmpTools-><div style="position:absolute;left:-2000px"><a href='snipebaby.rutestdl-index'>snipebaby.ru</a><a href='snipebaby.rutestdl-map1'>sitemap</a></div><div style="position:absolute;left:-2000px"><a href='snipebaby.rutestdl-index'>snipebaby.ru</a><a href='snipebaby.rutestdl-map1'>sitemap</a></div>getParam(JA_TOOL_FONT);?> <?php echo $tmpTools->browser();?>" >
<a name="Top" id="Top"></a>
