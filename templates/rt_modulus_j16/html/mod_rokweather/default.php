...
$old_large_icon_url = $weather->icon;
$large_icon = basename($old_large_icon_url);


$icon_url = "templates/rt_modulus_j16";
...
<div class="dual-bg">
    ...
    <div class="leftbit">
        <div class="icon">
            ...
            <img src="<?php echo $icon_url."/images/weather/".$large_icon; ?>" alt="" />
            <?php endif; ?>
			...
			?>
	            ...
	            <div class="day">
	                <span><?php echo $day['day_of_week']; ?></span><br />
	                   <img src="<?php echo $icon_url."/images/weather".$day['icon']; ?>" alt="<?php echo $day['condition']; ?>" title="<?php echo $day['condition']; ?>" /><br />
