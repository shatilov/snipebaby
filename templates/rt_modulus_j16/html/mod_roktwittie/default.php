...
<div id="roktwittie" class="roktwittie<?php echo $params->get('moduleclass_sfx'); ?>">
	...
	<div class="status">
		...
		?>
		<div class="user">
			<div class="header-wrapper <?php echo $header_style; ?>"><div class="dual-bg"><div class="dual-bg1"><div class="dual-bg2"><div class="dual-bg3"><div class="header">
				<div class="status-wrapper">
					<div class="avatar<?php if($show_default_avatar){echo " showavatar";} ?>" style="width: 32px; height: 32px;"><img src="<?php echo $user->profile_image_url?>" width="32" height="32" alt="<?php echo $id; ?>'s avatar" /></div>
					<div class="info">
