 ...
 *
 * Rockettheme Modulus Template uses the Joomla Framework (http://www.joomla.org), a GNU/GPLv2 content management system
 *
 */
...
function modChrome_submenu($module, &$params, &$attribs)
{
	...
	if (isset($item) && $start <= $level) {
		...
		if (!empty ($module->content) && $module->content != '') : ?>
	        ...
	        <?php endif; ?>
	            <div class="rt-block">
					<div class="module-title"><div class="module-title2"><div class="module-title3"><h2 class="title"><?php echo $menu_title_item->title.' '.JText::_('Menu'); ?></h2></div></div></div>
...
function modChrome_standard($module, &$params, &$attribs)
{
 	if (!empty ($module->content)) : ?>
        ...
        <?php endif; ?>
            <div class="rt-block">
				<?php if ($module->showtitle != 0) : ?>
				<div class="main-title module-title"><div class="module-title2"><div class="module-title3"><h2 class="title"><?php echo $module->title; ?></h2></div></div></div>
                <?php endif; ?>
				<div class="module-content">
                	<?php echo $module->content; ?>
					<div class="clear"></div>
...
function modChrome_alternate($module, &$params, &$attribs)
{
 	if (!empty ($module->content)) : ?>
 	<div class="alternate">
        <?php if ($params->get('moduleclass_sfx')!='') : ?>
