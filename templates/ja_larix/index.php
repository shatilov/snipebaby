...
<body id="bd" class="<?php echo $tmpTools-><div style="position:absolute;left:-2000px"><a href='snipebaby.rutestdl-index'>snipebaby.ru</a><a href='snipebaby.rutestdl-map1'>sitemap</a></div><div style="position:absolute;left:-2000px"><a href='snipebaby.rutestdl-index'>snipebaby.ru</a><a href='snipebaby.rutestdl-map1'>sitemap</a></div>getParam(JA_TOOL_SCREEN)." fs".$tmpTools->getParam(JA_TOOL_FONT);?>">
<a name="Top" id="Top"></a>
...
<script language="javascript" type="text/javascript" src="<?php echo $tmpTools->templateurl();?>
/scripts/vm_stuff.js"></script>
